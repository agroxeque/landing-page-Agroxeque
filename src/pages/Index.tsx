          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="w-full space-y-4">
              ...
              <AccordionItem value="creditos" className="bg-white rounded-lg border shadow-sm">
                ...
                <AccordionContent className="px-6 pb-4 text-gray-600 leading-relaxed">
                  Não. Erros na obtenção de imagens podem influenciar na geração dos resultados de duas formas diferentes: 1) Erros grosseiros que impedem que o ortomosaico seja gerado, ou 2) Erros mais sutis, que não impedem a geração do ortomosaico, mas resulta num produto final com falhas (borrões ou buracos no ortomosaico). Para o primeiro caso, onde o ortomosaico sequer é gerado, seus créditos serão estornados automaticamente, para que possa realizar uma nova aquisição de imagens e criar um novo projeto, sem custo adicional. Para a segunda situação, onde o ortomosaico é gerado e o restante do processamento é completado, mas os arquivos apresentam erros devido à problemas no ortomosaico gerado, você pode abrir uma solicitação de revisão de projeto, dentro do prazo estabelecido, diretamente pela plataforma. Nossa equipe irá analisar os arquivos referentes ao projeto desta solicitação e, ficando constatado que estes arquivos estejam de fato corrompidos, o total de créditos consumidos naquele projeto será estornado em sua conta, para que possa realizar uma nova aquisição de imagens e criar um novo projeto do zero. Mas atenção: em ambas as situações, você não pode aproveitar as imagens, enviando-as novamente. Este reembolso só é válido para que você faça um novo mapeamento, com parâmetros de voo mais rigorosos, garantindo que o segundo processamento seja realizado com sucesso.
                </AccordionContent>
              </AccordionItem>
