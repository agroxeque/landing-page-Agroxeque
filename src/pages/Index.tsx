...
{/* Dobra 1: O Impacto Imediato - Hero Section (VERSÃO CORRIGIDA FINAL) */}
      ...
      >
        ...
        */}
        <div className="w-full max-w-5xl mx-auto px-4 text-center relative z-10 flex flex-col items-center justify-start h-full min-h-[75vh] pt-8 md:pt-8 pb-8 md:pb-16 space-y-4 sm:space-y-6">
